...
public class CourseDAOImpl implements CourseDAO{
	...
	@Override
	public JobCode createCourse(final JobCode jc) throws DAOException {
		
		final StringBuilder query = new StringBuilder();
		StringBuilder valuesStr = new StringBuilder();
		valuesStr.append(" VALUES(?,?,?");
		
		query.append("INSERT INTO course(coursename, type, description");

		final JobCode predefinedJobCode = jc.getPredefinedJobCode();
		if(predefinedJobCode != null){
			query.append(", predefinedCourseId");
			valuesStr.append(",?");
		}
	...
	public List<Integer> getCourseList() throws DAOException{
		...
		StringBuilder query = new StringBuilder();
        query.append("SELECT id FROM course ");
	...
	@Override
	public void updateCourseByID(JobCode jc)
			throws DAOException {
		
		StringBuilder updateStatement = new StringBuilder();
		updateStatement.append("UPDATE course ");
		updateStatement.append("SET positionName=?, ");
		updateStatement.append("description=?, ");
		updateStatement.append("predefinedCourseId=? ");
	...
	public List<JobCode> getCourseForUserPreference() throws DAOException{
		...
		query.append("OR predefinedcourseid IS NULL");
	...
	public class JobCodeRowMapper implements RowMapper<JobCode>{
        ...
        public JobCode mapRow(ResultSet rs, int rowNum)
        	...
        	jc.setPositionName(rs.getString("courseName"));
        	...
        	jc.setPredefinedJobCodeID(rs.getInt("predefinedcourseId"));
